...
def load_data(training_data_path_str, testing_data_path_str, bureau_data_path_str, bureau_balance_data_path_str, credit_card_balance_data_path_str, installments_payments_data_path_str, pos_cash_balance_data_path_str, previous_application_data_path_str, enable_validation, target_name_str):
    """
